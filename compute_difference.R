compute_difference <- function(faasr) {
  ...
  # Print a log message
  # 
  log_msg <- paste0('Function compute_difference finished; output written to demo1-data/', args$output, ' in bucket S3_A defined in the JSON configuration')
