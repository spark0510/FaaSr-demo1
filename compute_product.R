compute_product <- function(faasr) {
  ...
  # Print a log message
  # 
  log_msg <- paste0('Function compute_product finished; output written to ', args$folder, '/', args$output, ' in My_S3_Bucket defined in the JSON configuration')
