prepare_data <- function(faasr) {
  ...
  # Print a log message
  # 
  log_msg <- paste0('Function prepare_data finished; output written to ', args$folder, '/', args$output, ' in My_S3_Bucket defined in the JSON configuration')
